        ...
        <div className="sketch-border bg-[#262626]/95 backdrop-blur-sm px-4 py-3 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <a 
              ...
              className="flex items-center bg-black px-3 py-1 rounded-lg border-2 border-[#8DC63F] hover:border-[#F9C93A] transition-colors"
            ...
            {/* <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center bg-[#0D1421] px-3 py-1 rounded-lg border-2 border-[#3861FB] hover:border-[#F9C93A] transition-colors"
